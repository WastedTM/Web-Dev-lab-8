    ...
    constructor(props) {
        ...
        this.state = {
            ...
            items: [
                {
                    id: 1,
                    title: 'ЗОЛОТІ СЕРЕЖКИ З САПФІРАМИ І ДІАМАНТАМИ',
                    productCode: "С200051",
                ...
                {
                    id: 2,
                    title: 'ЗОЛОТИЙ БРАСЛЕТ З ДІАМАНТАМИ',
                    productCode: "БР3028",
                ...
                {
                    id: 3,
                    title: 'ЗОЛОТА КАБЛУЧКА З ЧОРНИМИ ДІАМАНТАМИ',
                    productCode: "К100256",
                ...
                {
                    id: 4,
                    title: 'ЗОЛОТИЙ ХРЕСТИК З ДІАМАНТАМИ',
                    productCode: "П500",
                ...
                {
                    id: 5,
                    title: 'ЗОЛОТА КАБЛУЧКА ЗІ СМАРАГДАМИ І ЧОРНИМИ ДІАМАНТАМИ',
                    productCode: "К1707",
                ...
                {
                    id: 6,
                    title: 'ЗОЛОТІ СЕРЕЖКИ ЗІ СМАРАГДАМИ І ЧОРНИМИ ДІАМАНТАМИ',
                    productCode: "С2290",
            ...
            <Router>
                <div className='wrapper'>
                    ...
                    <Routes>
                        ...
                        <Route path="/Product/:id" element={<ShowFullItem items={this.state.items} onAdd = {this.addToOrder} addOneElement = {this.addOneOrder}/>} />
